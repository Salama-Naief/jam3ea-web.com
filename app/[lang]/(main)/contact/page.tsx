    ...
    <div>
      ...
      <div className="bg-gray-100 pt-10 pb-6 mb-4 w-full mx-auto sm:w-[40rem]">
        <div className="flex gap-3 justify-center">
          <a
            href="#"
            className="p-2 w-10 h-10 flex items-center justify-center rounded-full bg-success bg-opacity-20"
          >
            <PhoneArrowUpRightIcon className="w-4 h-4 text-success" />
          </a>
          <a
            href="#"
            className="p-2 w-10 h-10 flex items-center justify-center rounded-full bg-danger bg-opacity-20"
          >
            <svg
          ...
          <a
            href="#"
            className="p-2 w-10 h-10 flex items-center justify-center rounded-full bg-[#1DA1F2] bg-opacity-20"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="1em"
          ...
          <a
            href="#"
            className="p-2 w-10 h-10 flex items-center justify-center rounded-full bg-[#4267B2] bg-opacity-20"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="1em"
        ...
        {/* <div className="flex gap-4 px-4 items-center">
          <StarIcon className="text-primary w-6 h-6" />
          <div className="text-sm">Rate the app</div>
        </div> */}
      </div>
      <Container>
