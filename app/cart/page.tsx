        ...
        {cart.data.length === 1 && (
          <div id="single-supplier">
            <h5 className="text-base mb-2">
              {typeof cart.data[0].supplier.name === 'object'
                ? cart.data[0].supplier.name.en
                : cart.data[0].supplier.name}
            </h5>
            {cart.products.map((product) => (
              <div className="flex p-3 rounded-xl bg-white gap-3 items-center mb-3">
                <img
                ...
                <div className="flex items-center max-w-24 shadow-md rounded-md h-8 p-2 ms-auto">
                  <button id="minusBtn">
                    <svg
                    ...
                    >
                      ...
                      >
                        <path
                          id="Path_3131"
                          data-name="Path 3131"
                          d="M13.026,2.741H8.457A.457.457,0,0,1,8,2.284V1.371A1.372,1.372,0,0,1,9.371,0h2.741a1.372,1.372,0,0,1,1.371,1.371v.914A.457.457,0,0,1,13.026,2.741ZM8.914,1.827h3.655V1.371a.457.457,0,0,0-.457-.457H9.371a.457.457,0,0,0-.457.457Z"
                          transform="translate(-4.238 0.122)"
                          fill="#e82f3e"
                        />
                        <path
                          id="Line_27"
                          data-name="Line 27"
                          d="M11.336-.086H-.543A.457.457,0,0,1-1-.543.457.457,0,0,1-.543-1H11.336a.457.457,0,0,1,.457.457A.457.457,0,0,1,11.336-.086Z"
                          transform="translate(1.107 2.95)"
                          fill="#e82f3e"
                        />
                        <path
                          id="Path_3132"
                          data-name="Path 3132"
                          d="M10.748,16.792H4.217A1.377,1.377,0,0,1,2.85,15.527L2,4.492A.457.457,0,0,1,2.457,4H12.508a.457.457,0,0,1,.456.492l-.849,11.035A1.377,1.377,0,0,1,10.748,16.792ZM2.95,4.914l.811,10.543a.459.459,0,0,0,.455.422h6.531a.459.459,0,0,0,.455-.422l.811-10.543Z"
                          transform="translate(-0.979 -2.05)"
                          fill="#e82f3e"
                        />
                        <path
                          id="Line_28"
                          data-name="Line 28"
                          d="M-.543,8.137A.457.457,0,0,1-1,7.681V-.543A.457.457,0,0,1-.543-1a.457.457,0,0,1,.457.457V7.681A.457.457,0,0,1-.543,8.137Z"
                          transform="translate(5.675 4.777)"
                          fill="#e82f3e"
                        />
                        <path
                          id="Line_29"
                          data-name="Line 29"
                          d="M-.543,8.137A.457.457,0,0,1-1,7.681V-.543A.457.457,0,0,1-.543-1a.457.457,0,0,1,.457.457V7.681A.457.457,0,0,1-.543,8.137Z"
                          transform="translate(8.417 4.777)"
                          fill="#e82f3e"
                        />
                      </g>
                    </svg>
                  ...
                  <input
                    id="quantityInput"
                    type="text"
                    className="w-12 h-full border-0 text-center focus:outline-none"
                    ...
                    >
                      ...
                      >
                        ...
                        <g
                          id="Group_290"
                          data-name="Group 290"
                          transform="translate(5.908 0) rotate(90)"
                        >
                          <line
                            id="Line_8-2"
                            data-name="Line 8"
            ...
            <button className="flex py-4 mb-2 rounded-xl bg-white gap-3 items-center justify-center w-full">
              <svg
                id="Group_539"
                data-name="Group 539"
                xmlns="http://www.w3.org/2000/svg"
